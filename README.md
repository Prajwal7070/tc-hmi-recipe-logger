...
This project implements a custom TF1200 UI Client extension that captures Teach action from a TwinCAT HMI project and logs them into a timestamped file using a Node.js backend.
